# 교회문서키트 BASIC 1.3 작성기

내부 관리 버전: **BASIC 1.3 편의성 정리판**
...
- 로그인 후 상단에 `작성기 주소 복사` 버튼을 추가했습니다.
- 앱처럼 사용하기 안내에서 **메일 Sign in 링크는 임시 로그인용**이라고 명확히 안내했습니다.
- 구매자가 저장해야 할 주소는 메일 링크가 아니라 **작성기 기본 주소**임을 안내했습니다.
- PWA/바로가기 안내 문구를 더 쉽게 정리했습니다.
- 구매자 접속 안내 파일을 BASIC 1.3 기준으로 수정했습니다.
- 기존 BASIC 1.2의 PWA 설치 지원, 이메일 인증, 공용 PC 로그아웃 안내는 유지했습니다.
...
- 메일로 받은 `Sign in` 링크는 로그인용 임시 링크입니다.
- 계속 사용할 주소는 작성기 기본 주소입니다.
- 로그인 후 `작성기 주소 복사` 버튼을 눌러 즐겨찾기/바로가기/홈 화면에 저장합니다.
